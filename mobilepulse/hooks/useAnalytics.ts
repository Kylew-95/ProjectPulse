...
export const useAnalytics = (timeRange: TimeRange) => {
    ...
    const fetchData = useCallback(async () => {
        ...
        setLoading(true);
        try {
            // We select raw data and aggregate on client to match web logic
            // For a production app with huge data, this should be an RPC or Edge Function
            ...
            currentPeriodTickets.forEach(t => {
                ...
                const assignee = t.assignee_profile as any;
