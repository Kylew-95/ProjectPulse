...
const ThemeToggle = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-900/10 dark:bg-white/5 hover:bg-slate-900/20 dark:hover:bg-white/10 border border-slate-900/10 dark:border-white/10 transition-all duration-300 shadow-sm group relative"
