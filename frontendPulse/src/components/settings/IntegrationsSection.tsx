...
const IntegrationsSection = () => {
  ...
  return (
    <section className="relative mb-6 space-y-6">
        ...
        {/* Pro+ Integrations */}
        <ProGate featureName="Integrations" description="Connect your favorite tools like Jira, Trello, GitHub, and Slack. Upgrade to Pro to unlock integrations.">
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/5 rounded-2xl p-6">
